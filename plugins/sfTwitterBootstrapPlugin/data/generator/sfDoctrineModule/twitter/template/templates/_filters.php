...
<?php endforeach; ?>
    <td>
      ...
      [?php echo link_to($icon_reset . __("Болих", array(), 'sf_admin'), '<?php echo $this->getUrlForAction('collection') ?>', array('action' => 'filter'), array('class' => 'btn btn-default btn-sm', 'query_string' => '_reset', 'method' => 'post')) ?]
    </td>
  </tr>
</form>
