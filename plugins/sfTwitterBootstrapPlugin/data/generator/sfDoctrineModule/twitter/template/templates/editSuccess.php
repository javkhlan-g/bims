...
<div id="sf_admin_container" class="panel panel-default">
    <div class="panel-heading">
            ...
            [?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset =>
            $fields): ?]
    ...
    <div class="panel-body">
        ...
        <div id="sf_admin_header">
            ...
            array('<?php echo $this->getSingularName() ?>' => $<?php echo $this->getSingularName() ?>, 'form' => $form,
