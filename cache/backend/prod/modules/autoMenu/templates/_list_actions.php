            ...
            <div class="modal-content">
                <form action="<?php echo url_for('menu_collection', array('action' => 'filter')) ?>" method="post">
                    ...
                    <div class="modal-body">
                        <table class="table" cellspacing="0">
                            <tbody>
                                ...
                                <?php include_partial('menu/filters_field_modal', array(
                                'name'       => $name,
                    ...
                    <div class="modal-footer">
                        ...
                        <?php echo link_to(__('Reset', array(), 'sf_admin'), 'menu_collection', array('action' => 'filter'), array('class' => 'btn', 'query_string' => '_reset', 'method' => 'post')) ?>
