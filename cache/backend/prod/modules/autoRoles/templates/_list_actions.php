            ...
            <div class="modal-content">
                <form action="<?php echo url_for('roles_collection', array('action' => 'filter')) ?>" method="post">
                    ...
                    <div class="modal-body">
                        <table class="table" cellspacing="0">
                            <tbody>
                                ...
                                <?php include_partial('roles/filters_field_modal', array(
                                'name'       => $name,
                    ...
                    <div class="modal-footer">
                        ...
                        <?php echo link_to(__('Reset', array(), 'sf_admin'), 'roles_collection', array('action' => 'filter'), array('class' => 'btn', 'query_string' => '_reset', 'method' => 'post')) ?>
